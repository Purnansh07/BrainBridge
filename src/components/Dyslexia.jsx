...
const Dyslexia = () => {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            const prompt = `
Based on the following responses to dyslexia screening questions, provide an assessment for Dyslexia:

1. Do you have difficulty reading fluently? (${q1})
2. Do you have trouble spelling words correctly? (${q2})
3. Do you have difficulty with word recognition? (${q3})
4. Do you have trouble with phonological awareness (recognizing and manipulating sounds in words)? (${q4})
5. Do you have difficulty with reading comprehension? (${q5})
6. Do you have trouble with writing and organizing thoughts on paper? (${q6})
7. Do you have difficulty with grammar and punctuation? (${q7})
8. Do you have trouble with word retrieval (finding the right word when speaking)? (${q8})
9. Do you have difficulty with rapid naming (quickly naming objects, colors, or letters)? (${q9})
10. Do you have trouble with letter-sound correspondence? (${q10})
11. Do you have difficulty with visual processing of text? (${q11})
12. Do you have trouble with working memory related to language tasks? (${q12})
13. Do you have difficulty with directional confusion (left/right, up/down)? (${q13})
14. Do you have trouble with sequencing (following multi-step instructions)? (${q14})
15. Do you have difficulty with time management and organization? (${q15})

Based on these responses, provide a preliminary assessment for Dyslexia, recommend a specialist, and suggest treatment options.

IMPORTANT: Format your response as a valid JSON object with exactly these fields:
{
  "diagnosis": "Your assessment here (including likelihood of dyslexia)",
...
`;
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        setLoading(true);
        console.log("Submitting Dyslexia assessment data");
        fetchData();
    };
                ...
                {apiData ? (
                    <>
                        {apiData.diagnosis && apiData.specialist && apiData.treatment_options ? (
                            <>
                                <h1 className="font-poppins text-3xl text-start">Dyslexia Assessment</h1>
                    ...
                    <>
                        <h1 className="text-3xl font-bold font-poppins mb-4">Dyslexia Assessment</h1>
                                ...
                                <div className="flex justify-center w-full items-center flex-col mb-6">
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q1" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            1. Do you have difficulty reading fluently?
                                        </label>
                                        <select
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q2" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            2. Do you have trouble spelling words correctly?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q2"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q3" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            3. Do you have difficulty with word recognition?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q3"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q4" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            4. Do you have trouble with phonological awareness (recognizing and manipulating sounds in words)?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q4"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q5" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            5. Do you have difficulty with reading comprehension?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q5"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q6" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            6. Do you have trouble with writing and organizing thoughts on paper?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q6"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q7" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            7. Do you have difficulty with grammar and punctuation?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q7"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q8" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            8. Do you have trouble with word retrieval (finding the right word when speaking)?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q8"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q9" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            9. Do you have difficulty with rapid naming (quickly naming objects, colors, or letters)?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q9"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q10" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            10. Do you have trouble with letter-sound correspondence?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q10"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q11" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            11. Do you have difficulty with visual processing of text?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q11"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q12" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            12. Do you have trouble with working memory related to language tasks?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q12"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q13" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            13. Do you have difficulty with directional confusion (left/right, up/down)?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q13"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q14" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            14. Do you have trouble with sequencing (following multi-step instructions)?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q14"
                                    ...
                                    <div className="w-full px-3 mb-6">
                                        <label htmlFor="q15" className="font-poppins block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">
                                            15. Do you have difficulty with time management and organization?
                                        </label>
                                        <select
                                            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            id="q15"
